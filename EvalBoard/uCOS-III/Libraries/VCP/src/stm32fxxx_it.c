...
* Description    : This function handles interrupt events generated by USART6
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
